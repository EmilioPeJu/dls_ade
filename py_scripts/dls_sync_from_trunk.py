...
def main():
# >>> Script doesn't use any parser arguments?
    parser = make_parser()
...
#        parser.error("Incorrect number of arguments.")
    ...
    prop_list = svn.propget("dls:synced-from-trunk", ".",
                            svn.Revision(svn.opt_revision_kind.working), False)
    ...
    svn.propset('dls:synced-from-trunk', str(trunk_revision), ".",
                svn.Revision(svn.opt_revision_kind.working), False)
